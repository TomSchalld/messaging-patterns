...
@Service
@Profile({"multi", "all"})
public class MultiplyReceiver implements MessageReceiver {

    private static final Logger LOGGER = LoggerFactory.getLogger(MultiplyReceiver.class);
    ...
    @JmsListener(destination = "${orchestrator.multi.queue}")
    @Override
