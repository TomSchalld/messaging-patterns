...
@Component
@Profile({"multi","all"})
public class Multi implements MathematicalOperation, MessageReceiver {

    private static final Logger LOGGER = LoggerFactory.getLogger(Multi.class);
    ...
    @JmsListener(destination = "calc.q.in.multi")
    @Override
